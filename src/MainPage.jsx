...
const MainPage = () => {
  ...
  return ( 
    <>
    <motion.div className='flex flex-col items-center justify-end absolute top-3 right-1 p-1 rounded-lg px-4 pb-2 shadow-br shadow-[#f8f8f2] bg-gradient-to-br from-gray-800 to-transparent lg:top-3 lg:right-7 sm:top-3 sm:right-7' initial={{ x: 30, opacity: 0 }} animate={{y: 15, x: -15, opacity: 1 }} transition={{ duration: 1 }}>
